...
<ul>
	<li>Inner Melbourne location</li>
	<li>$55K - $75K, based on skill and experience</li>
	<li>Work and learn on cutting edge web technology</li>
</ul>
...
<ul>
	<li>Open source or commercial experience with either Ruby on Rails or JavaScript (Angular JS as bonus)</li>
	<li>Be open and willing to keep learning in Ruby on Rails / JavaScript</li>
	<li>HTML5 proficiency, HAML experience a bonus</li>
	<li>A software engineering background or similar</li>
	<li>Great communication skills</li>
	<li>A curious and passionate mind</li>
</ul>
